...
if st.session_state.method == "RLCD":
    with st.form("input"):
        ...
        cols = st.columns(3)
        with cols[0]:
            st.session_state.rlcd_input_file_dir = st.text_input("Prompt File", value="ata-output")
        with cols[1]:
            st.session_state.rlcd_output_chosen = st.text_input("Output Chosen", value="ata-output")
        with cols[2]:
            st.session_state.rlcd_output_rejected = st.text_input("Output Rejected", value="ata-output")
        ...
        with cols[1]:
            st.session_state.rlcd_infer_chosen = st.text_input("Output chosen file", value="ata-output")
            st.session_state.rlcd_infer_rejected = st.text_input("Output rejected file", value="ata-output")
        with cols[2]:
        ...
        cols = st.columns(3)
        with cols[0]:
            st.session_state.rlcd_dpo_chosen = st.text_input("Chosen file", value="ata-output")
            st.session_state.rlcd_dpo_rejected = st.text_input("Rejected file", value="ata-output")
        with cols[1]:
        ...
        with cols[2]:
            st.session_state.rlcd_output_dir = st.text_input("Output dir", value="ata-output")
...
"""
    ...
    with st.form("input"):
        ...
        cols = st.columns(3)
        with cols[0]:
            st.session_state.spin_model_name = st.text_input("Model name", value="Qwen2.5-Ins")
            st.session_state.spin_model_path = st.text_input("Model path", value="/141nfs/arknet/hf_models/Qwen1.5-1.8B-Chat/")
        with cols[1]:
            st.session_state.spin_test_file = st.text_input("Prompt file", value="data/dummy_spin_query.json")
            st.session_state.spin_template = st.text_input("Template name", value="chatml")
        with cols[2]:
            st.session_state.spin_source = st.text_input("Rejected source tag", value="Qwen2.5_rejected")
        st.write("prepare for dpo")
        cols = st.columns(3)
        with cols[0]:
            st.session_state.spin_dpo_input_chosen = st.text_input("Chosen file", value="data/dummy_spin_golden.json")
            st.session_state.spin_dpo_input_rejected = st.text_input("Rejected file", value="ata-output")
        with cols[1]:
            st.session_state.spin_dpo_chosen_source = st.text_input(
                "Dpo chosen source tag", value="golden"
            )
            st.session_state.spin_dpo_rejected_source = st.text_input(
                "Dpo rejected source tag", value="Qwen2.5_rejected"
            )
        with cols[2]:
            st.session_state.spin_output_file_dir = st.text_input("Output dir", value="ata-output")
            st.session_state.self_re_log_dir = st.text_input("Logging dir", value="outputs")
...
autoalign-cli infer --backend "vllm" \
            ...
            --output-dir {st.session_state.spin_dpo_input_rejected}
...
"""
    ...
    with st.form("input"):
        ...
        with cols[1]:
            st.session_state.cai_sft_input_path = st.text_input("Input file", value="ata-output")
        ...
        with cols[3]:
            ...
            st.session_state.cai_sft_output_sft = st.text_input("Output sft file name", value="ata-output")
            st.session_state.self_re_log_dir = st.text_input("Logging dir", value="outputs")
...
"""
    ...
    with st.form("input"):
        ...
        with cols[1]:
            st.session_state.cai_dpo_input_path = st.text_input("Input file", value="ata-output")
            st.session_state.cai_dpo_output_path = st.text_input("Output file", value="ata-output")
            st.session_state.self_re_log_dir = st.text_input("Logging dir", value="outputs")
...
python algorithms/cai/temperature_sample.py   --model-name {st.session_state.cai_dpo_model_name} \
    ...
    with st.form("input"):
        ...
        with cols[1]:
            ...
            st.session_state.output_path = st.text_input("Output Path", value="ata-output")
        with cols[2]:
            st.session_state.self_re_num_iter = st.text_input("Num iter", value=1)
            st.session_state.self_re_ins_path = st.text_input("Instruction path", value="ata-output")
            st.session_state.self_re_log_dir = st.text_input("Logging dir", value="outputs")

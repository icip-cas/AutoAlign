...
if "selected_button" not in st.session_state:
    st.session_state.selected_button = "SFT"
st.markdown("<span style='color: blue;'>数据生成 ———————— 数据筛选 ———————— 训练</span> ———————— 评测", unsafe_allow_html=True)
st.session_state.selected_button = st.selectbox(
    "流程选择: ",

#!/bin/bash
# A100 SFT Training Script - LiteCoder dataset, seq=64K, CP=2
# Usage: bash scripts/train/megatron/train/a100/sft_litecoder.sh

set -e

echo "=== A100 SFT Training (LiteCoder, seq=64K) ==="
...
SAVE_PATH="./checkpoints/sft/qwen2.5-7b-litecoder-tp2-pp2-cp2-seq64k"

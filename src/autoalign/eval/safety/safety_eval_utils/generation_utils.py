...
def create_and_inference_with_vllm(
    ...
    llm = load_vllm_model(model_name_or_path, tokenizer_mode=tokenizer_mode, tensor_parallel_size=tensor_parallel_size)
...
def subprocess_inference_with_vllm(
    ...
    subprocess = ctx.Process(
        ...
        args=(
            prompts, model_name_or_path, tokenizer_mode, do_chat_formatting, tokenizer, tensor_parallel_size, use_tqdm,

...
class SimPOTrainerForQwen(DPOTrainer):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)  # Pass all other arguments using **kwargs
        self.gamma = kwargs["args"].gamma
...
class DPOTrainerForQwen(DPOTrainer):
    def __init__(self, *args, **kwargs):
